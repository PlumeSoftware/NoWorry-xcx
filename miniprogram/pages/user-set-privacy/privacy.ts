...
import { textareaProps } from "miniprogram/miniprogram_npm/@vant/weapp/field/props";
...
Page({
    data: {
        paragraph: [
            ...
            "在申请签证的过程中，如果您提供以下额外信息，将有助于我们给您提供更好的服务和体验：手机号、工作职位、公司、学校、护照号、护照截止时间等。因为签证类型的不同，所要求的信息内容则不同，但如果您不提供这些信息，将不会影响使用本服务的基本功能。",
            "您提供的上述信息，将在您使用本服务期间持续授权我们使用。在您完成签证申请后，我们将根据双方协定停止使用并删除上述信息。",
            ...
            "我们收集数据是根据您与我们的互动和您所做出的选择，包括您的隐私设置以及您使用的产品和功能。我们收集的数据可能包括您的电话、邮箱、相关签证信息等。",
            ...
            "账户信息——如果您希望访问或编辑您的账户中的个人资料信息或关闭您的账户等，您可以通过访问本小程序执行此类操作。",
            "搜索信息——您可以在本小程序中访问或清除您的搜索历史记录、查看和修改兴趣以及管理其他数据。",
            "",
            "五、本隐私权政策如何更新",
            ...
            "",
            "七、如何联系我们 如果您对本隐私政策有任何疑问、意见或建议，通过小程序内部的联系方式与我们联系：",
            "一般情况下，我们将在三十天内回复。",
        ]
    }
});
