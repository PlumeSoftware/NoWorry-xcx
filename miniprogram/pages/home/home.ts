...
Component({
    data: {
        ...
        qaList: [
            ...
            ["Q: 申请A国申根签证可以去B国吗？", "A: 可以。在您出游的第一拥有一个申根国家的签证可以通行整个欧盟26国！只要在签证有效期内入境A国即可。"],
            [
                "Q: 我可以拿到多久的签证？",
                ["A: 申根签不是申请多久就给多久的，所以一般分两种情况，一是国家，二是材料。",
                    "一，法签/西班牙/德签相对于其他国家给的时间比较长，大多数情况都是90天-180天左右，而北欧（挪威/冰岛/丹麦/芬兰）给的时效比较短，10天-90天的情况都存在。",
                    "二，如果有以下情况存在，签证的有效期也会增长: ", "1. 5年内有过几次申根签记录。 ", "2.卡内余额3000磅以上，流水越多越好。", "3.增加行程时间的长度和次数。"]
            ],
            ["Q: 几天可以拿到签证？", "A: 递签后一般在10天-20天可以拿到护照，建议您预留充足的签证时间。"],
